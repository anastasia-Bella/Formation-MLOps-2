...
def predict_endpoint():
    ...
    receive_data = {"Wind_turbine_name": "R80721", "Date_time": "2017-02-08T08:00:00+01:00", "Ba_avg": 44.99, "Ba_min": 44.99,
     ...
     "Yt_max": 20.79, "Yt_std": 0.07, "": received_wind_speed_avg, "Ws1_min": 0.0, "Ws1_max": 1.94, "Ws1_std": 0.44,
    ...
    received_data_df = pd.DataFrame(receive_data, index=[0])
